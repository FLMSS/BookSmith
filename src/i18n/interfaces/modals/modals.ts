...
export interface ModalTranslation {
    ...
    TARGET_UNIT: string;
    TARGET_UNIT_DESC: string;
    TARGET_UNIT_PAGES_DESC: string;
    TARGET_VALUE_DESC: string;
    TARGET_WORD_COUNT: string;
    TARGET_PAGE_COUNT: string;
    TARGET_WORDS: string;
    ...
    // ExportModal
    EXPORT_BOOK_TITLE: string;
    PDF_FORMAT_DESC: string;
    MARKDOWN_FORMAT_DESC: string;
    FOUNTAIN_FORMAT_DESC: string;
    DOCX_FORMAT_DESC: string;
    REMOVE_COMMENTS: string;
    REMOVE_LINKS: string;
    REMOVE_FRONTMATTER: string;
    SELECT_EXPORT_FORMAT_FIRST: string;
    
    // BookSelectionModal
    SELECT_BOOKS_TO_EXPORT: string;
    EXPORT_SETTINGS: string;
    NO_BOOKS_FOUND: string;
    CREATE_BOOK_FIRST_TO_EXPORT: string;
    CREATED_DATE: string;
    SELECT_BOOK_FIRST_TO_EXPORT: string;
    LOAD_BOOKS_FAILED: string;
    OPEN_EXPORT_FAILED: string;
}