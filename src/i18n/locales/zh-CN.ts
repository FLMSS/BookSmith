...
const toolViewTranslation: ToolViewTranslation = {
    ...
    BACK_TO_TOOLBOX: '返回工具箱',
    WRITING_STATS_CALENDAR: '统计',
    GLOBAL_STATS: '全局统计',
    SELECT_PROJECT: '选择项目',
    NO_ACTIVE_BOOK: '请先选择一本书再查看写作统计。',
    PREVIOUS_MONTH: '上个月',
    NEXT_MONTH: '下个月',
    DISPLAY_MODE: '显示',
    WRITING_STATS_MODE: '写作统计',
    PROGRESS_DISPLAY_TYPE: '进度显示类型',
    PROGRESS_DISPLAY: '进度显示',
    PROGRESS_DISPLAY_TYPE_DESC: '选择如何解释进度，应用于左侧面板和状态小部件。',
    PROGRESS_DISPLAY_TYPE_INFO: '大多数写作软件只显示净字数变化。比如你一天开始和结束都是 10,000 字，追踪器只会显示：0\n\n但这个数字无法说明当天究竟发生了什么。New Material 指标会在净进度之外，补充稿件变化的上下文。\n\n示例：\n0 (+10000 | -10000)\n\n净值仍然是 0，但你可以看出你重写了整段 10,000 字场景。\n\n🟣 紫色：当天写出的新内容\n🔴 红色：从稿件中移除的旧内容\n\n紫色数值只会增加，红色数值只会减少，能更直观看出当天工作的类型。',
    PROGRESS_MODE_NET_HINT: 'New Material（净值，默认）\n主数值显示稿件净进度，并附带“新写内容 / 删除旧稿”的拆解。\n适用于大多数写作场景。\n\n🟣 新写内容\n🔴 删除旧稿\n\n示例：\n+3\n(+4 | -1)',
    PROGRESS_MODE_DAILY_HINT: 'New Material（日产出）\n主数值显示当天新写内容。\n稿件净变化仍会显示，但作为次级上下文。\n\n🟣 新写内容\n🔴 删除旧稿\n\n示例：\n+4\n(+4 | -1)',
    PROGRESS_MODE_RAW_HINT: 'Raw Data\n按原始编辑行为显示新增与删除，把当天迭代也计入完整写作活动。\n\n🟣 新增\n🔴 删除\n\n示例：\n+3\n(+5 | -2)',
    STATS_PERIOD: '周期',
    WORDS_MODE: '字数',
    PAGES_MODE: '页数',
    POMODOROS_MODE: '番茄钟',
    HOURS_MODE: '小时',
    NEW_MATERIAL_NET_MODE: '新内容（净值）',
    NEW_MATERIAL_DAILY_OUTPUT_MODE: '新内容（日产出）',
    RAW_DATA_MODE: '原始数据',
    PERIOD_DAY: '日',
    PERIOD_WEEK: '周',
    PERIOD_MONTH: '月',
    PERIOD_YEAR: '年',
    WORDS_PER_PAGE: '每页字数',
    APPLY_STATS_SETTINGS: '应用',
    JUMP_TO_YEAR: '跳转',
    INVALID_YEAR: '请输入有效年份。',
    WORDS_WRITTEN_ON: '{date}：写了 {words} 字',
    PAGES_WRITTEN_ON: '{date}：写了 {pages} 页',
    WORDS_WRITTEN_IN_PERIOD: '{period}：写了 {words} 字',
    PAGES_WRITTEN_IN_PERIOD: '{period}：写了 {pages} 页',
    POMODOROS_IN_PERIOD: '{period}：完成了 {pomodoros} 个番茄钟',
    NO_WRITING_RECORD: '所选日期没有写作记录。',
    NO_WRITING_RECORD_PERIOD: '所选周期没有写作记录。',
    NO_POMODORO_RECORD_PERIOD: '所选周期没有专注记录。',
    ENTER_WORDS_PER_PAGE: '每页平均字数是多少？',
    INVALID_WORDS_PER_PAGE: '请输入大于 0 的有效数字。',
    WORD_UNIT_SHORT: '字',
    PAGE_UNIT_SHORT: '页',
    POMODORO_UNIT_SHORT: '番',
    HOURS_UNIT_SHORT: 'h',
    DAY_COMMENT: '今天写作状态怎么样？',
    DAY_COMMENT_PLACEHOLDER: '记录一下今天写作的感受和进展...',
    SAVE_DAY_COMMENT: '保存评论',
    DAY_COMMENT_SAVED: '当日评论已保存',
    NAVIGATOR: '导航器',
    NAVIGATOR_REFRESH: '刷新导航器',
    NAVIGATOR_NOT_SET_TITLE: '当前项目尚未设置导航器文件夹。',
    NAVIGATOR_NOT_SET_DESC: '请选择一个文件夹作为该项目的资源导航目录。',
    NAVIGATOR_NO_FILES: '所选文件夹内没有可显示的支持文件。',
    NAVIGATOR_FOLDER_SAVED: '已为当前项目保存导航器文件夹。',
    NAVIGATOR_SELECT_FOLDER: '选择导航器文件夹',
    NAVIGATOR_FOLDER_SEARCH_PLACEHOLDER: '搜索文件夹...',
    NAVIGATOR_NO_MATCHING_FOLDERS: '没有匹配的文件夹',
    SELECT_FOLDER: '选择文件夹',

    // 写作助手
    WRITING_ASSISTANT: '写作助手',
    FOCUS_MODE: '专注模式',
    FOCUS_SELECT_PROJECT: '选择专注项目',
    FOCUS_UNASSIGNED: '未分配',
...
const settingsTranslation: SettingsTranslation = {
    ...
    DEFAULT_TEMPLATE_DESC: '创建新书籍时使用的散文模板',
    BOOK_TEMPLATES: '书籍模板',
    ...
    WRITING_DAY_ENDS_AT: '写作日结束时间',
    WRITING_DAY_ENDS_AT_DESC: '在这个时间之前记录的写作会计入前一天。'
};
...
const modalTranslation: ModalTranslation = {
    ...
    TARGET_UNIT: '目标单位',
    TARGET_UNIT_DESC: '选择目标值以字数或页数输入。',
    TARGET_UNIT_PAGES_DESC: '当目标单位为页数时使用。与右侧统计设置共享。',
    TARGET_VALUE_DESC: '以所选单位设置目标值。',
    ...
    TEMPLATE_SAVE_FAILED: '保存模板失败，请查看控制台了解详情',
        // ExportModal
    EXPORT_BOOK_TITLE: '导出项目',
    PDF_FORMAT_DESC: '便携文档格式',
    MARKDOWN_FORMAT_DESC: '导出为 Markdown (.md) 文件',
    FOUNTAIN_FORMAT_DESC: '导出为 Fountain (.fountain) 文件',
    DOCX_FORMAT_DESC: 'Word文档格式',
    REMOVE_COMMENTS: '移除注释',
    REMOVE_LINKS: '移除链接',
    REMOVE_FRONTMATTER: '移除 frontmatter',
    SELECT_EXPORT_FORMAT_FIRST: '请先选择导出格式',
        // BookSelectionModal
    SELECT_BOOKS_TO_EXPORT: '选择要导出的项目',
    EXPORT_SETTINGS: '导出设置',
    NO_BOOKS_FOUND: '未找到任何书籍',
    CREATE_BOOK_FIRST_TO_EXPORT: '请先创建一本书籍再进行导出',
    CREATED_DATE: '创建日期',
    SELECT_BOOK_FIRST_TO_EXPORT: '请先选择一本书籍',
    LOAD_BOOKS_FAILED: '加载书籍列表失败',
    OPEN_EXPORT_FAILED: '打开导出模态框失败'
};
...
const componentTranslation: ComponentTranslation = {
    ...
    OPEN_FOLDER_FILES_IN_ORDER: '按顺序打开文件夹内全部文件',
    OPEN_ALL_FILES_IN_ORDER: '按顺序打开全部文件',
    NO_FILES_TO_OPEN: '没有可打开的文件',
