...
class NotesTemplate implements ImgTemplate {
    ...
    render(element: HTMLElement, settings?: any) {
        ...
        pages.forEach((page, index) => {
            ...
            header.innerHTML = `<div class="notes-title">Notes</div><div class="notes-date">${new Date().toLocaleDateString()}</div>`;
...
class MagazineTemplate implements ImgTemplate {
    ...
    render(element: HTMLElement, settings?: any) {
        ...
        pages.forEach((page, index) => {
            ...
            header.innerHTML = `<div class="magazine-section">Feature</div>`;
